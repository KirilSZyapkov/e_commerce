                        ...
                        <div className='grid'>
                            ...
                            <div className="col-md-3">
                                <div className="gettouch">
                                    ...
                                    <p><i className="fa fa-home"></i> Philippines, PO Box 6200 Talay st. 65, SweetPick inc.</p>
                                    <p><i className="fa fa-phone"></i> +63 918 4084 694</p>
                                    <p className="mb20"><i className="fa fa-envelope"></i> samokhinteam@gmail.com</p>
                                    <h1>FIND US ON</h1>
